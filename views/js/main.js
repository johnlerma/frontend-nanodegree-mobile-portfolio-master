...
function resizePizzas(size) {
    ...
    function changePizzaSizes(size) {
        ...
        //added first of type to only grab the first .randomPizzaContainer
        var randomPizzas = document.querySelectorAll(".randomPizzaContainer div:first-of-type");
...
// declared global var items
var items;

function updatePositions() {
    frame++;
    window.performance.mark("mark_start_frame");
    // moved document.body.scrollTop outside of the loop
    // changed to getElelementsByclassName to call the specific class name
    ...
    //set letsanimate back to false after updating the positions stops
    letsAnimate = false;
...
//wrapped the updatePositions into a requestAnimation
function scrollwrap() {
    requestAnimationFrame(updatePositions);
}
